...
//4) they can be invoked (used) as many times as we want, cutting down on code repition
...
console.log(sentence('John', 'Doe'));
let superImportantSentence = sentence('Dick', 'Cheney');
console.log(superImportantSentence);

//let's build a function that takes a complex type--an array in this case, and console.logs each item in the inout array
